    ...
    public Ventana() {
        ...
        crearButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (txtFieldNombreUD.getText().isEmpty()){
        ...
        crearCargoButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (txtFieldSueldo.getText().isEmpty() || txtFieldNombreCargo.getText().isEmpty()){
                    JOptionPane.showMessageDialog(null,"Rellene todos los campos");
                }
                else {
        ...
        añadirButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (txtFieldCedula.getText().isEmpty() || txtFieldNombre.getText().isEmpty()){
                    JOptionPane.showMessageDialog(null,"Rellene todos los campos para poder seguir");
                }else{
        ...
        buscarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (txtFieldCedulaModificar.getText().isEmpty()){
                    JOptionPane.showMessageDialog(null,"Rellene todos los campos ");
                }else {
        ...
        modificarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Empleado empleado=lista.buscar(txtFieldCedulaModificar.getText());
                if (txtFieldCedulaModificar.getText().isEmpty() || txtFieldCedulaM.getText().isEmpty() || txtFieldNombreM.getText().isEmpty()){
                    JOptionPane.showMessageDialog(null,"Rellene todos los campos para poder actualizar la info");
                }else {
                    empleado.setCedula(txtFieldCedulaM.getText());
                    empleado.setNombreEmpleado(txtFieldNombreM.getText());
        ...
        busquedaButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (txtFieldNombreBusqueda.getText().isEmpty()){
